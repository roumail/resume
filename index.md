...
<div class="cv-container">
  <div class="sidebar" style="display: flex; flex-direction: column;">
    ...
    <h2>Personal details</h2>
      <ul>
        <li><strong>Nationality:</strong> Belgian, Pakistani</li>
        <li><strong>Languages:</strong> English (fluent/bilingual), Urdu (Native), French (B1)</li>
        <li><strong>Mobility:</strong> Driving Licence available, flexible for hybrid setup with up to 4 days on site</li>
        <li><strong>Availability:</strong> Immediately</li>
        <li><strong>Hobbies:</strong> Drumming and percussion instruments, Bouldering/Climbing, productivity, Squash, reading</li>
      </ul>
  </div>
